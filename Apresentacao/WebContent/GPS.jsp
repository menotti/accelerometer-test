...
<%@page import="java.io.InputStreamReader" %>
 ...
 <head> 
		...
		function infos(evt){
    		...
    		if(evt.offsetY<120){
      		...
      		if(evt.offsetX<890){
      			...
      			element.setAttributeNS(null,"x",910);
      		}
      		if(evt.offsetY<120){
      		...
      		if(evt.offsetY<120){
    			element.setAttributeNS(null,"y",evt.offsetY+70);
      			...
      			element.setAttributeNS(null,"y",70);
      		}
   ...
   <body> 
			...
			try{
				<%
					...
					if(positions != null){
						...
						document.write("Distância percorrida: " + Math.floor(comprimento) + " metros.");
    ...
    <script type="text/javascript">
    document.writeln("<svg width=\"1000\" height=\"200\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" onload=\"init(evt)\" >");
    document.writeln("<polyline id=\"speed\" points=\"0,200 " + velocidades + " 1000,200\" "+
    ...
    document.writeln("<polyline id=\"altitude\" points=\"0,200 " + alturas + " 1000,200\" "+
